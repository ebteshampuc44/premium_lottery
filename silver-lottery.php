...
<body class="font-inter bg-dark text-light min-h-screen">
    ...
    <section class="py-12 md:py-16">
        <div class="container mx-auto px-4">
            <div class="max-w-6xl mx-auto">
                <!-- Content will be loaded from dashboard -->
                <div id="silver-lottery-content" class="text-center text-gray-400 py-12">
                    <i class="fas fa-spinner fa-spin text-4xl mb-4"></i>
                    <p>Loading Silver Lottery content...</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <script>
        ...
        window.addEventListener('load', function() {
            ...
            setTimeout(() => {
                const contentArea = document.getElementById('silver-lottery-content');
                contentArea.innerHTML = `
                    <div class="text-center text-gray-400 py-12">
                        <i class="fas fa-medal text-6xl mb-6 text-silver"></i>
                        <h2 class="text-3xl font-bold text-white mb-4">Silver Lottery</h2>
                        <p class="text-xl mb-8">Content will be loaded from admin dashboard.</p>
