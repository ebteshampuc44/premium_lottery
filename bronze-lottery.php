                ...
                <?php else: ?>
                    <div class="text-center mb-10">
                        ...
                        <div class="flex justify-center items-center mt-4">
                            <div class="glass-effect rounded-lg px-4 py-2">
                                <span class="text-bronze font-semibold">Ticket Price: ৳30</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <?php foreach($tickets as $ticket): ?>
                            <div class="glass-effect rounded-xl p-6 hover:shadow-lg transition-shadow border border-bronze/20">
                                <div class="flex justify-between items-start mb-4">
                                    <div>
                                        <span class="text-sm text-gray-400">Ticket Number</span>
                                        <h3 class="text-xl font-bold font-mono text-bronze"><?php echo $ticket['ticket_number']; ?></h3>
                                    </div>
                                ...
                                <button onclick="buyTicket('bronze', '<?php echo $ticket['ticket_number']; ?>', <?php echo $ticket['prize_amount']; ?>)" 
                                        class="w-full bg-gradient-to-r from-amber-700 to-amber-900 text-white py-3 rounded-xl font-bold hover:opacity-90 transition-opacity">
