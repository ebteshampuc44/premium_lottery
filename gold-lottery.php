...
<head>
    ...
    <title>Gold Lottery - LottoElite</title>
...
<body class="font-inter bg-dark text-light min-h-screen">
            ...
            <div class="flex justify-between items-center">
                ...
                <a href="index.php" class="flex items-center space-x-3 hover:opacity-90 transition-opacity">
                    ...
                    <div class="hidden md:block">
                        ...
                        <p class="text-xs text-gray-400">Gold Lottery</p>
                    </div>
                </a>
    ...
    $query = "SELECT lt.* FROM lottery_tickets lt 
              ...
              WHERE ltp.slug = 'gold-lottery' AND lt.is_active = 1 
            ...
            <div class="max-w-6xl mx-auto">
                <?php if(empty($tickets)): ?>
                    <div class="text-center text-gray-400 py-12">
                        <i class="fas fa-ticket-alt text-6xl mb-6 text-gold"></i>
                        <h2 class="text-3xl font-bold text-white mb-4">Gold Lottery</h2>
                        <p class="text-xl mb-8">Tickets will be added soon!</p>
                        <a href="index.php#lotteries" class="inline-flex items-center text-gold hover:text-goldLight transition-colors">
                            <i class="fas fa-arrow-left mr-2"></i> Back to All Lotteries
                        </a>
                    </div>
                <?php else: ?>
                    <div class="text-center mb-10">
                        <h2 class="text-3xl md:text-4xl font-bold text-white mb-4">Gold Lottery</h2>
                        ...
                        <div class="flex justify-center items-center mt-4">
                            <div class="glass-effect rounded-lg px-4 py-2">
                                <span class="text-gold font-semibold">Ticket Price: ৳100</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <?php foreach($tickets as $ticket): ?>
                            <div class="glass-effect rounded-xl p-6 hover:shadow-lg transition-shadow border border-gold/20">
                                <div class="flex justify-between items-start mb-4">
                                    <div>
                                        <span class="text-sm text-gray-400">Ticket Number</span>
                                        <h3 class="text-xl font-bold font-mono text-gold"><?php echo $ticket['ticket_number']; ?></h3>
                                    </div>
                                ...
                                <button onclick="buyTicket('gold', '<?php echo $ticket['ticket_number']; ?>', <?php echo $ticket['prize_amount']; ?>)" 
                                        class="w-full bg-gradient-to-r from-yellow-600 to-amber-700 text-white py-3 rounded-xl font-bold hover:opacity-90 transition-opacity">
